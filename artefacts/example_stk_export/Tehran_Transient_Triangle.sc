...
BEGIN Scenario
    Name            Tehran_Transient_Triangle
...
BEGIN Extensions
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	28 Oct 2025 08:30:00.000000000
				Stop	29 Oct 2025 08:30:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        D:\Program Files\STK 11 (x64)\Tehran_Transient_Triangle
            BaseName         Frame
            Digits           4
            Frame            0
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Facility/Tehran_Target
        Facility/Tehran_Target
    END Instance
    Instance Satellite/Sat1_Chief
        Satellite/Sat1_Chief
        Satellite/Sat1_Chief/Sensor/Sat1_Cone
    END Instance
    Instance Satellite/Sat1_Chief/Sensor/Sat1_Cone
        Satellite/Sat1_Chief/Sensor/Sat1_Cone
    END Instance
    Instance Satellite/Sat2_Dep_A
        Satellite/Sat2_Dep_A
        Satellite/Sat2_Dep_A/Sensor/Sat2_Cone
    END Instance
    Instance Satellite/Sat2_Dep_A/Sensor/Sat2_Cone
        Satellite/Sat2_Dep_A/Sensor/Sat2_Cone
    END Instance
    Instance Satellite/Sat3_Dep_B
        Satellite/Sat3_Dep_B
        Satellite/Sat3_Dep_B/Sensor/Sat3_Cone
    END Instance
    Instance Satellite/Sat3_Dep_B/Sensor/Sat3_Cone
        Satellite/Sat3_Dep_B/Sensor/Sat3_Cone
    END Instance
END References
