...
| MR-2 | Analysis & Test | Mission Analysis Cell with Orbit Determination Team | SIM-NODE-2024-01: Scenario propagation using `sim/scripts/run_scenario.py` with Tehran daily pass configuration | Cross-track error ≤10 km across propagated cycles; current evidence (`run_20251018_1345Z`) shows 439–445 km offsets and 0.0 compliance probability, so redesign or requirement update is required before closure.【F:sim/scripts/run_scenario.py†L1-L200】【F:artefacts/run_20251018_1345Z/deterministic_summary.json†L6-L47】【F:artefacts/run_20251018_1345Z/monte_carlo_summary.json†L1-L33】 |
