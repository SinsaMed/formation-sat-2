...
| MR-2 | Analysis & Test | Mission Analysis Cell with Orbit Determination Team | SIM-NODE-2024-01: Scenario propagation using `sim/scripts/run_scenario.py` with Tehran daily pass configuration | Cross-track error ≤10 km across propagated cycles; JSON summary archived with metric trace supporting review gates.【F:sim/scripts/run_scenario.py†L1-L200】 |
...
| SRD-R-003 | Analysis, Test & Demonstration | Fault Management Tiger Team | FMECA-004: Fault injection analysis; RECOV-SIM-001: contingency simulation runbook | Recovery from ±5 km along-track error achieved with <12 h manoeuvre planning time and Δv ≤14 m/s; all fault trees updated and baselined.【F:tests/integration/test_simulation_scripts.py†L96-L130】 |
