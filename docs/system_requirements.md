...
| SRD-P-001 | Performance | The orbital design shall hold each operational plane within ±10 km absolute cross-track error over Tehran during the scheduled daily pass. | Clarifies MR-2 per CCB direction so that acceptance is tied to observable pass performance whilst preserving the ±10 km tolerance.【F:docs/mission_requirements.md†L9-L33】 | High-fidelity \(J_2\)+drag propagation with 3 s sampling accompanied by a ten-run Monte Carlo dispersion set, archived under run_20251018_1936Z_tehran_daily_pass and cross-checked for STK export compatibility.【F:docs/verification_plan.md†L53-L88】【F:docs/stk_export.md†L1-L120】 | C — run_20251018_1936Z_tehran_daily_pass records minima of 2.62 km, 5.86 km, and 7.28 km with a fleet compliance probability of 1.0, closing the previous non-compliance.[EV-6]【F:artefacts/run_20251018_1936Z_tehran_daily_pass/deterministic_summary.json†L1-L48】【F:artefacts/run_20251018_1936Z_tehran_daily_pass/monte_carlo_summary.json†L1-L77】 |
