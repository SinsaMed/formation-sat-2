...
| SRD-P-001 | Performance | The orbital design shall ensure the ascending nodes of Planes A and B intersect above the target latitude and longitude with cross-track error not exceeding ±10 km. | Maintains the MR-2 alignment requirement for target overflight synchronisation.【F:docs/mission_requirements.md†L14-L17】 | Numerical propagation and ground-track analysis validated against STK export standards (Analysis).【F:docs/verification_plan.md†L1-L23】【F:docs/stk_export.md†L1-L120】 | NC — Deterministic analysis shows 439–445 km absolute offsets and the Monte Carlo catalogue records 0.0 compliance probability in run_20251018_1345Z [EV-5], so the requirement remains open.【F:artefacts/run_20251018_1345Z/deterministic_summary.json†L6-L47】【F:artefacts/run_20251018_1345Z/monte_carlo_summary.json†L1-L33】【F:docs/compliance_matrix.md†L41-L55】 |
