...
| MR-2 | Mission Requirements | NC | run_20251018_1345Z high-fidelity perturbation analysis[EV-5] | Absolute cross-track offsets of 439–445 km and a plane-intersection miss distance of \(1.81\,\text{Mm}\) breach the ±10 km requirement; mission geometry redesign or requirement re-scoping is required before compliance can be claimed. |
...
| SRD-P-001 | System Requirements | NC | run_20251018_1345Z high-fidelity perturbation analysis[EV-5] | Deterministic absolute cross-track offsets remain \(> 400\,\text{km}\) and Monte Carlo compliance probability is 0.0, violating the ±10 km acceptance criterion; corrective action or formal requirement amendment is outstanding. |
