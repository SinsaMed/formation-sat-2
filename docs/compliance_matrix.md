...
| MR-5 | Mission Requirements | C | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study[EV-3] | Single-station command latency measured at \(1.53\,\text{h}\) with \(10.47\,\text{h}\) margin; regression `tests/unit/test_triangle_formation.py` guards compliance. |
| MR-6 | Mission Requirements | C | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study[EV-3] | Weekly formation-keeping burns expend \(14.04\,\text{m/s}\) annually, preserving \(0.96\,\text{m/s}\) margin beneath the 15 m/s cap. |
| MR-7 | Mission Requirements | C | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study[EV-3] | Monte Carlo injection recovery succeeds in 300/300 trials with \(p_{95}\) \(\Delta v = 0.041\,\text{m/s}\), satisfying robustness expectations. |
...
| SRD-O-001 | System Requirements | C | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study[EV-3] | Single-station command uplink achieved within \(1.53\,\text{h}\); latency ledger enforced via automated tests. |
| SRD-P-004 | System Requirements | C | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study[EV-3] | Annual \(\Delta v\) of \(14.04\,\text{m/s}\) meets propulsion budgeting requirement with documented weekly duty cycle. |
| SRD-R-001 | System Requirements | C | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study[EV-3] | Monte Carlo recovery catalogue evidences full success within \(15\,\text{m/s}\) per-spacecraft allocation. |
...
| [EV-3] | run_20251101_0803Z_tehran_triangle maintenance and responsiveness study covering MR-5 to MR-7 | `artefacts/run_20251101_0803Z_tehran_triangle` | Includes maintenance, command, and Monte Carlo CSV catalogues plus SVG CDF plot; supporting interpretation retained within `docs/triangle_formation_results.md`. Windowed and full-propagation ground-distance maxima (\(345.91\,\text{km}\) and \(658.41\,\text{km}\)) are recorded explicitly to prevent ambiguity in compliance traceability.[Ref7][Ref8] |
...
- [Ref8] Formation-Sat Systems Team, *run_20251101_0803Z Tehran Triangle Analytics Campaign*, FS-ANL-006 v1.0, 2025.
