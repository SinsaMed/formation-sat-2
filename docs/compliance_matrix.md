...
| MR-2 | Mission Requirements | C | run_20260321_0740Z_tehran_daily_pass_resampled Tehran daily pass alignment analysis[EV-5] | Centroid cross-track of \(12.14\,\text{km}\) at 07:40:10Z with a worst-vehicle absolute offset of \(27.76\,\text{km}\) satisfies the ±30 km tolerance and preserves headroom beneath the ±70 km waiver ceiling. |
...
| SRD-P-001 | System Requirements | C | run_20260321_0740Z_tehran_daily_pass_resampled Tehran daily pass alignment analysis[EV-5] | Deterministic centroid cross-track remains at \(12.14\,\text{km}\) with a \(27.76\,\text{km}\) worst-vehicle offset at the mandated midpoint sample, confirming compliance while Monte Carlo centroid statistics are scheduled for extension. |
